...
SECRET_KEY = 'django-insecure-f@_juf3h*@o-)+kjk%cc$_&pb0lf^bo-zfz2wuag6c@lu59h*u'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'static') # Referencia local onde estão os arquivos estáticos.
STATIC_URL = 'static/'
# Referencia local onde os arquivos estarão gravados
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'alurareceita/static')
]
# Rota para os arquivos de media
